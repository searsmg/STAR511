...
Groups A and D seem to have similar mean yields. Group C seems to have produced a different mean yield than D and A. Group B mean yield is likely most similar to group C. 
...
B. The residuals versus fitted plot is assessing the variance or equality of variance. If there is equality of variance, then in the plot we will see equal scatter among the points. This plot shows primarily equal variance in the residual diagnostic plot. 
...
the means and the confidence intervals *******
...
The normality of residuals is voilate in the second plot since the points are not on or near the line. The residuals are right skewed. **
...
C. We can do a hypotheses tests here even though the assumption are violated since the Kruskal-Wallis test is a non-parametric alternative to the one-way ANOVA F-test. This test does not require the assumption of normality and equality of variances. 
